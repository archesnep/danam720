"""
Django settings for danams project.
"""
...
DATATYPE_LOCATIONS.append('danams.datatypes')
FUNCTION_LOCATIONS.append('danams.functions')
ETL_MODULE_LOCATIONS.append('danams.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('danams.search_components')
...
SECRET_KEY = '(^jpa7px_a1a4*d%o8ixhf14^ppgiuw%1mm#sdef+)f50!f%wo'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'danams.urls'
...
ELASTICSEARCH_PREFIX = 'danams'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'danams.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'danams.wsgi.application'
